...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM4,  CH2, PB7,  TIM_USE_VTOL_MOTOR,   1, 0), // S1 D(1,3,2)
    DEF_TIM(TIM4,  CH1, PB6,  TIM_USE_VTOL_MOTOR,   1, 0), // S2 D(1,0,2)
    ...
    DEF_TIM(TIM12, CH1, PB14, TIM_USE_VTOL_SERVO,   1, 0), // S7
    DEF_TIM(TIM12, CH2, PB15, TIM_USE_VTOL_SERVO,   1, 0), // S8

    DEF_TIM(TIM1,  CH1, PA8,  TIM_USE_VTOL_MOTOR,   1, 0), // S9
